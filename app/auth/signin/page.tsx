                  ...
                  if (provider.name === 'Google') {
                    return (
                      <Button
                        ...
                        variant="outline"
                        className="w-full border-gray-300 dark:border-gray-600 text-card-foreground hover:border-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                  ...
                  if (provider.name === 'GitHub') {
                    return (
                      <Button
                        ...
                        disabled={isSubmitting}
                        variant="outline"
                        className="w-full border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
